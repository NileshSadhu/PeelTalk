  ...
  return (
    <>
      {partnerId ? (
        ...
        <button
          onClick={toggleMenu}
          className="lg:hidden fixed top-4 left-4 z-50 p-2 rounded-lg bg-[#FFF872] hover:bg-yellow-500 transition-colors"
        >
      ...
      <div
        className={`
                fixed lg:static w-64 lg:w-80 h-screen bg-linear-to-b bg-[#FFF872] shadow-lg
