...
import { MessageBubbleProps } from "./chat.type";
import { getAvatarFromUsername } from "@/utils/crypto/getAvatar";
...
export const MessageBubble = ({
  ...
  return (
    <div
      className={`my-2 scroll-mt-20 flex ${isCurrentUser ? "justify-end" : "justify-start"} w-full px-2`}
    >
      <div
        ...
        <div className="flex flex-col relative">
          ...
          <div
            ...
            className={`relative bg-[#F9F4F2] text-[#4B2E1E] p-2 sm:p-3 rounded-lg shadow cursor-pointer
                            ...
                            ${
                              isCurrentUser
                                ? "before:right-0 before:border-l-10 sm:before:border-l-12 before:border-l-[#F9F4F2] before:border-b-10 sm:before:border-b-12 before:border-b-transparent"
                                : "before:left-0 before:border-r-10 sm:before:border-r-12 before:border-r-[#F9F4F2] before:border-b-10 sm:before:border-b-12 before:border-b-transparent"
                            }
                        `}
          >
