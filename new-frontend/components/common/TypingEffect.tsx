...
export const TypingEffect = () => {
    return (
        <div
            className="balsamiq-sans-regular-italic  font-medium text-base sm:text-lg md:text-xl text-amber-900 wrap-break-word whitespace-normal min-h-18 md:min-h-20">
            <Typewriter
                words={[
